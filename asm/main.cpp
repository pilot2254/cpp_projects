...
extern "C" const char* asm_hello_world();
...
extern "C" long long asm_fibonacci(long long n);
...
extern "C" char* asm_string_reverse(char* str);
...
int main() {
        ...
        // strings & chars
        char str[] = "banana";
        std::cout << "ASM Strlen: " << asm_strlen(str) << '\n';
        std::cout << "ASM Char Count: " << asm_string_char_count(str, 'a') << '\n';
        std::cout << "ASM Str Reverse: " << asm_string_reverse(str) << '\n';
